...
\begin{math}
  m_{x}(t) = \intinf e^{tx}\frac{exp(-\frac{(x-\mu)^2}{2\sigma^2})}{\sqrt{2\pi\sigma^2}} \, dx
           = \pisigma \intinf exp(-\frac{x^2-2\mu x + \mu^2 - 2\sigma^2 tx}{2\sigma^2}) \, dx
           = \pisigma \intinf exp(-\frac{x^2-2x(\mu+\sigma^2t) - (\mu+\sigma^2 t)^2 + (\mu+\sigma^2 t)^2}{2\sigma^2}) \, dx
           = exp(-\frac{\mu^2 - (\mu + \sigma^2 t)^2}{2\sigma^2} )
             \cdot
             \pisigma \intinf exp(-\frac{(x - (\mu+\sigma^2 t))^2}{2\sigma^2}) \, dx
           = [\text{the integral equals } 1]
