...
\begin{math}
  m_{x}(T) = \sum_{x=1}^{\infty}{e^{tx}(1-p)^{n-1}p}
...
\begin{math}
  m_{x}(t) = \int_{-\infty}^{\infty}{e^{tx}\frac{exp(-\frac{(x-\mu)^2}{2\sigma^2})}{\sqrt{2\pi\sigma^2}}dx}
           = \frac{1}{\sqrt{2\pi\sigma^2}}\int_{-\infty}^{\infty}{exp(-\frac{1}{2\sigma^2}(x^2-2\mu x + \mu^2 - 2\sigma^2 tx))dx}
           = \frac{1}{\sqrt{2\pi \sigma^2}}\int_{-\infty}^{\infty}{exp(-\frac{1}{2\sigma^2}(x^2-2x(\mu+\sigma^2t) - (\mu+\sigma^2 t)^2 + (\mu+\sigma^2 t)^2))dx}
           = exp(-\frac{1}{2\sigma^2}(\mu^2 - (\mu + \sigma^2 t)^2))\cdot \frac{1}{\sqrt{2\pi \sigma^2}}\int_{-\infty}^{\infty}{exp(-\frac{1}{2\sigma^2}(x-(\mu+\sigma^2 t)^2))dx}
           = hela\ R.V.\ ger\ 1\ (biten\ efter\ \cdot)
...
\begin{math}
  P(|X-\mu| \ge \varepsilon) = P(|X-\mu|^2 \ge \varepsilon^2) \le(med\ markov's)\ \frac{E|X-\mu|^2}{\varepsilon^2}
                             = \frac{Var(X)}{\varepsilon^2}
\end{math} \\[2pt]

\subsection{Confidence Intervals}
\begin{math}
  X_{1}..X_{n},\ X_i \sim N(\mu,\sigma^2)
\end{math} \\[2pt]
\begin{math}
...
\begin{math}
  ...
  P(|\frac{\bar{X} - \mu}{\sigma/\sqrt{n}} \le Z_{\alpha/2}|) =
  P(|\bar{X}-\mu| \le Z_{\alpha/2} \frac{\sigma}{\sqrt{n}}) =
  P(\bar{X}-Z_{\alpha/2} \frac{\sigma}{\sqrt{n}} \le \mu \le \bar{X}+Z_{\alpha/2} \frac{\sigma}{\sqrt{n}}) =
  1 - \alpha
\end{math} \\[2pt]
% (end)
